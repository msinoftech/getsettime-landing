            ...
            <div className="relative z-20 mx-auto container px-4 sm:px-6 lg:px-8">
                <div className="space-y-6 max-w-xl lg:max-w-[calc(50%-3rem)]">
                    ...
                    <div className="flex flex-col gap-4 sm:flex-row">
                        <Link href={`${REGISTER_GOOGLE_URL}`} target="_blank" aria-label="Sign up with Google - Dermatology Appointment Scheduling Software" className="flex items-center justify-center gap-3 rounded-xl bg-indigo-600 px-4 py-2.5 text-sm text-white">
