...
const pageUrl = `${BASE_URL}/solutions/hair-salon-appointment-scheduling-app`;

export const metadata: Metadata = {
    title: `Hair Salon Booking Software | ${APP_NAME} – Smart Appointment Scheduling`,
    description: `The easiest hair salon scheduling software - Book clients online 24/7, send auto WhatsApp reminders & reduce no-shows — no tech skills needed. Try free today.`,
    keywords: [ "appointment scheduling software for hair salon", "software for hair salons", "hair salon booking systems", "hair salon scheduling software", "hair salon booking software", "hair salon appointment software", "hair salon management system",],
    alternates: {
      canonical: `${pageUrl}`,
    },
    openGraph: {
...
export default function HairSalonAppointmentSchedulingApp() {

const faqItems = [
    {
        title: "Is GetSetTime only for large salons?",
        content: `No. It works for individual stylists, boutique studios, growing salons, and multi-location beauty brands.`,
    },
    {
        title: "Can clients book from Instagram or WhatsApp?",
        content: `Yes. You can share your booking link anywhere and let clients book in just a few taps.`,
    },
    {
        title: "Does it support multiple staff members?",
        content: `Yes. You can manage team availability, assign services, and control appointment slots by staff member.`,
    },
    {
        title: "Can we collect deposits before confirmation?",
        content: `Yes. You can set up deposits or advance payments for selected services to reduce last-minute cancellations.`,
    },
];
...
const schemaData = {
    ...
    "@graph": [
        ...
        "@id": `${pageUrl}/#WebPage`,
        "url": `${pageUrl}`,
        "name": `Hair Salon Booking Software | ${APP_NAME} – Smart Appointment Scheduling`,
        "description": "The easiest hair salon scheduling software - Book clients online 24/7, send auto WhatsApp reminders & reduce no-shows — no tech skills needed. Try free today.",
        "inLanguage": "en",
        "isPartOf": {
          "@type": "WebSite",
        ...
        "audience": {
          "@type": "HairSalonAudience",
          "audienceType": "Individual Stylists, Boutique Studios, Growing Salons, Multi-Location Beauty Brands",
        },
        "featureList": [
...
const features = [
    ...
    icon: `<svg version="1.1" id="_x32_" viewBox="0 0 512 512" xml:space="preserve" width="40px" height="40px" fill="#4f39f6"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <style type="text/css"> .st0{fill:#4f39f6;} </style> <g> <rect x="146.966" class="st0" width="218.067" height="189.867"></rect> <polygon class="st0" points="365.033,209.049 146.966,209.049 98.998,280.883 413.002,280.883 "></polygon> <polygon class="st0" points="98.998,340.692 98.998,512 145.995,512 145.995,340.692 366.005,340.692 366.005,512 413.002,512 413.002,340.692 413.002,299.67 98.998,299.67 "></polygon> </g> </g></svg>`,
    },
    {
    ...
    icon: `<svg width="40px" height="40px" viewBox="0 0 24 24" fill="none"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <rect x="3" y="6" width="18" height="13" rx="2" stroke="#4f39f6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></rect> <path d="M3 10H20.5" stroke="#4f39f6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M7 15H9" stroke="#4f39f6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>`,
    },
];
...
return (
    ...
    <Script id="salon-appointment-scheduling-app-schema" type="application/ld+json" strategy="beforeInteractive" dangerouslySetInnerHTML={{ __html: JSON.stringify(schemaData, null, 2),}}/>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-6">
                ...
                <div className="space-y-6">
                    <div className="inline-flex items-center gap-2 rounded-full border border-indigo-200 bg-white px-4 py-2 text-xs font-semibold uppercase tracking-widest text-indigo-700 shadow-sm">
                        ...
                        Built to grow modern salons
                    </div>
                    <h1 className="text-3xl md:text-4xl lg:text-[50px] font-black text-neutral-900">
                    Hair Salon Booking Software
                    <span className="bg-gradient-to-r from-indigo-700 via-violet-600 to-sky-500 bg-clip-text text-transparent"> That Fills Every Chair</span>
                    </h1>
                    <p>GetSetTime is the simplest salon appointment system built for hair salon owners — no tech skills needed. Automate bookings, send reminders, and never lose a client to a missed appointment again.</p>
                        ...
                        <div className="p-0">
                            <div className="px-5 pt-4">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <div className="font-medium text-indigo-600">GetSetTime Salon Dashboard</div>
                                        <div className="mt-1 font-semibold text-neutral-900">Today’s Appointments</div>
                                    </div>
                                    <div className="rounded-full bg-emerald-50 px-3 py-1 text-xs font-semibold text-emerald-600">Live Schedule</div>
                                </div>
                            </div>
                            <div className="grid gap-4 p-4 md:grid-cols-2">
                                <div className="rounded-2xl border border-emerald-100 bg-emerald-50 p-4 space-y-3">
                                    <div className="font-semibold text-neutral-600">Upcoming Bookings</div>
                                    <div className="space-y-3">
                                        {[
                                            ["10:00 AM", "Haircut + Styling", "Priya"],
                                            ["11:30 AM", "Facial Treatment", "Anjali"],
                                            ["02:00 PM", "Nail Art Session", "Simran"],
                                            ...
                                            <div key={time} className="rounded-xl bg-white p-3 shadow-md">
                                                <div className="flex items-start justify-between gap-3">
                                                    <div>
                                                        ...
                                                        <div className="text-neutral-600">Client: {client}</div>
                                                    </div>
                                ...
                                <div className="rounded-2xl border border-indigo-100 bg-indigo-50 p-4 space-y-3">
                                    <div className="font-semibold text-neutral-600">Salon Team</div>
                                    <div className="space-y-3">
                                        {[
                                            ["Riya", "Hair Specialist", "Available"],
                                            ["Mehak", "Skin & Facial Expert", "Busy"],
                                            ["Jasleen", "Nail Artist", "Available"],
    ...
    <section className="relative py-14 sm:py-20 bg-gradient-to-b from-white to-indigo-50 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center max-w-4xl mx-auto mb-16 space-y-3">
                ...
                <h2 className="text-3xl md:text-4xl lg:text-[40px] font-black text-neutral-900">One Appointment System For All Your Hair Salon Needs</h2>
                <p>GetSetTime is the perfect app for hair salons, designed to manage resources efficiently and let users book appointments online quickly.</p>
            </div>
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid items-center gap-10 lg:grid-cols-2">
                ...
                <div className="space-y-3">
                    ...
                    <h2 className="text-3xl md:text-4xl lg:text-[40px] font-black text-neutral-900">Launch Personalized Salon booking system in simple Steps</h2>
                    ...
                    <div className="rounded-2xl bg-[#f5f6fb] text-neutral-900">
                        <div className="grid gap-4 lg:grid-cols-[1fr_1.05fr]">
                            <div className="rounded-2xl bg-white p-4 shadow-sm">
                                ...
                                <div className="text-neutral-600">Hair & Beauty Studio · Open Today</div>
                            ...
                            <div className="space-y-3">
                                <div className="mt-4 rounded-xl border border-neutral-100 p-3 space-y-1">
                                    ...
                                    <div>
                                        <div className="font-semibold text-neutral-900">Riya Mehta</div>
                                ...
                                <div className="rounded-2xl bg-white p-4 shadow-sm">
                                    ...
                                    <button className="mt-4 rounded-xl bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-md">Save Schedule</button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid gap-6 lg:grid-cols-2">
                ...
                <div className="relative rounded-2xl bg-[radial-gradient(circle_at_top_left,_rgba(99,102,241,0.15),_transparent_30%),linear-gradient(180deg,#f8faff_0%,#eef2ff_100%)] shadow-md p-4 space-y-3">
                    ...
                    <div className="inline-flex z-10 items-center gap-3 rounded-full border border-indigo-200 bg-white/80 px-4 py-2 text-xs font-semibold uppercase tracking-widest text-indigo-600 shadow-sm backdrop-blur">
                        <span className="w-2 h-2 bg-indigo-500 rounded-full" />
                        Why Salon Choose us?
                    </div>
                    <h2 className="z-10 text-3xl md:text-4xl lg:text-[40px] font-black text-neutral-900">Personalized Branding, Smooth Operations, Pleasing Client Experience</h2>
                    <div className="z-10 relative mt-8 grid gap-3 md:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2">
                        {[
                        "Get Your Own Dashboard",
                        "Branding: Name, Logo, Tagline",
                        "Sync Calendar and Set Availability Rules",
                        "Manage Your Staff Effortlessly",
                        "Let's allow clients to book, reschedule, and cancel via a link",
                        "Real-Time Automated Calendar Management",
                        ].map((item) => (
                        <div key={item} className="rounded-xl bg-white px-4 py-3 shadow-md flex items-center gap-3 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                ...
                <div className="relative space-y-3">
                    ...
                    <h2 className="text-3xl md:text-4xl lg:text-[40px] font-black text-neutral-900">Without A Hair Salon Scheduling Software</h2>
                    <p>It is more costly than investing in an appointment booking app when you spend time managing bookings on paper, in WhatsApp groups, or by memory.</p>
                    <div className="mt-6 space-y-3">
                        {[
                        ...
                        <div key={item} className="flex items-center gap-3 rounded-xl bg-white p-4 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                            <div className="flex h-9 w-9 min-w-9 min-h-9 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-600 to-indigo-500 text-white shadow-lg shadow-indigo-500/25">✓</div>
                            {item}
                        </div>
                        ))}
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-2 items-start">
          ...
          <div className="space-y-4">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-[40px] font-bold text-neutral-900">One System For Before, During, And After Every Appointment</h2>
            <p>As client demand increases, manual booking creates delays, front-desk overload, and inconsistent follow-up. A structured digital system helps your salon deliver faster and more predictable service.</p>
            <div className="space-y-3">
              {[
          ...
          <div className="relative rounded-xl border border-white/70 bg-white/90 p-4 shadow-2xl backdrop-blur">
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-2">
              ...
              <div className="rounded-xl border border-indigo-200 bg-indigo-50 p-3">
                <div className="text-indigo-500">Keratin</div>
        ...
        <div className="grid gap-4 lg:grid-cols-3 mt-8">
            {automationCards.map((card, index) => (
                <div key={card.title} className="group relative overflow-hidden rounded-3xl bg-white p-5 shadow-md transition duration-300 hover:-translate-y-1 hover:shadow-xl">
                    <div className="absolute right-3 top-3 rounded-full border border-indigo-100 bg-white px-2 py-1 text-[11px] font-semibold text-indigo-500">
                        0{index + 1}
                    </div>
                    <div className='inline-flex rounded-full bg-indigo-600 px-3 py-1 text-xs font-semibold text-white shadow'>
                        {card.title}
                    </div>
        ...
        <div className="mt-8 rounded-xl border border-white/70 bg-white/90 p-5 shadow-xl backdrop-blur">
          ...
          <div className="mt-5 text-center">
            <Link href={`${LOGIN_URL}`} target="_blank" className="inline-flex items-center justify-center rounded-xl bg-indigo-600 px-5 py-2.5 text-white shadow-md transition hover:bg-indigo-700">Start your salon booking setup</Link>
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-indigo-50 via-white to-violet-100 py-20">
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative z-10 space-y-4">
                ...
                <h2 className="text-3xl md:text-4xl lg:text-[40px] font-black text-neutral-900">A Practical Plan To Grow Your Salon In 30 Days</h2>
            ...
            <div className="relative">
                ...
                <div className="pointer-events-none absolute left-0 -bottom-10 rounded-xl border border-violet-100 bg-white p-4 shadow-xl animate-float">
                    ...
                    <div className="mt-1 font-bold text-neutral-900">Priya S · 11:30 AM</div>
    ...
    <section className="relative overflow-hidden bg-[radial-gradient(circle_at_top_left,rgba(99,102,241,0.14),transparent_28%),radial-gradient(circle_at_top_right,rgba(168,85,247,0.16),transparent_24%),linear-gradient(180deg,#f8fafc_0%,#ffffff_48%,#f8fafc_100%)] py-14 sm:py-20">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-8 lg:grid-cols-[1fr_1.15fr] lg:gap-12 px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-3">
                ...
                <h2 className="text-3xl md:text-4xl lg:text-[40px] font-black text-neutral-900">Questions Salon Owners Ask Before Getting Started</h2>
                <p>GetSetTime is built for salon owners who want to grow their business online. We answer the most common questions salon owners have about our platform.</p>
