    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: `${APP_NAME} – Scheduling Software for Appointment Booking`,
      },
    ],
  },
  twitter: {
          ...
          <div className="grid items-center gap-6 lg:gap-10 lg:grid-cols-2">
              ...
              <div className="relative flex justify-center">
                <div className="relative w-full">
                  ...
                  <div className="relative rounded-2xl z-2 sm:bg-white/80 sm:p-4 shadow-xl">
                    <div className="overflow-hidden rounded-2xl border border-neutral-200 shadow-inner">
                      ...
                      <div className="space-y-4 bg-[radial-gradient(circle_at_top_left,_rgba(99,102,241,0.08),_transparent_35%),linear-gradient(180deg,#f7f4ee_0%,#f4efe5_100%)] px-4 py-4 sm:px-6 sm:py-6">
                        <div className="max-w-[88%] sm:max-w-[76%] rounded-[26px] rounded-tl-md bg-white px-4 py-3 text-sm text-neutral-700 shadow-sm">
                          <p>Hi Nora 👋</p>
                          <p>Your appointment is confirmed for <strong>Tomorrow at 4:00 PM.</strong></p>
                        </div>
                        <div className="ml-auto max-w-[50%] rounded-[26px] rounded-tr-md bg-gradient-to-r from-emerald-500 to-green-500 px-4 py-3 text-white shadow-sm">
                          <p>Great, thank you.</p>
                        </div>
                  ...
                  <div className="absolute -left-0 lg:-left-5 -top-5 z-1 hidden lg:block rounded-full bg-gradient-to-br from-emerald-500 to-green-500 shadow-xl p-4 animate-float">
                  ...
                  <div className="absolute -bottom-10 right-5 z-2 hidden lg:block rounded-xl bg-white px-4 py-4 shadow-sm animate-float">
                  ...
                  <div className="absolute -left-0 lg:-left-6 bottom-45 z-2 hidden lg:block rounded-xl bg-white px-4 py-4 shadow-sm animate-float">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid items-center gap-6 lg:gap-10 lg:grid-cols-2">
            ...
            <div className="relative">
              <div className="group relative w-full rounded-2xl bg-white p-4 shadow-xl transition-all duration-500">
              ...
              <div className="animate-float rounded-xl bg-white p-3 shadow-lg transition-all duration-500 group-hover:shadow-xl w-50 hidden lg:block absolute -top-10 right-0 group-hover:-translate-y-1">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-8 lg:grid-cols-[1fr_1.15fr] lg:gap-12 px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-3">
            <Heading
              ...
              title="Answers that feel as smooth as your booking flow."
              description="Turn a plain FAQ block into a premium conversion section. This layout gives GetSetTime a more modern SaaS feel with glassmorphism, soft gradients, animated cards, and a stronger content hierarchy."
            />
