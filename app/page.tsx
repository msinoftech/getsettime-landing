...
export const metadata: Metadata = {
  title: `${APP_NAME} – Scheduling Software for Appointment Automation`,
    ...
    images: [
      {
        ...
        width: 500,
        height: 500,
        alt: `${APP_NAME} – Scheduling Software for Appointment Automation`,
      },
    ],
  },
  twitter: {
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-4 lg:gap-16 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-8">
          ...
          <div className="space-y-3">
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              {whatsappFeatures.map((item) => (
                <div key={item} className="group rounded-xl bg-white/80 p-3 shadow-xl transition-all duration-300 hover:-translate-y-1">
          ...
          <div className="relative flex justify-center">
            <div className="relative w-full">
              ...
              <div className="relative rounded-2xl z-2 border border-white/60 bg-white/80 p-4 shadow-xl">
                <div className="overflow-hidden rounded-2xl border border-neutral-200 shadow-inner">
                  <div className="flex items-center justify-between border-b border-neutral-200 bg-white/80 px-4 py-3">
                    <div className="flex items-center gap-4">
                      <div className="h-12 w-12 flex items-center justify-center rounded-full bg-gradient-to-br from-emerald-500 to-green-500 shadow-xl shadow-emerald-500/30">
                      ...
                      <div>
                        ...
                        <div className="text-neutral-500">online now</div>
                      </div>
                    </div>
                    <div className="font-medium text-emerald-600">Active automation</div>
                  </div>
                  ...
                  <div className="space-y-4 bg-[radial-gradient(circle_at_top_left,_rgba(99,102,241,0.08),_transparent_35%),linear-gradient(180deg,#f7f4ee_0%,#f4efe5_100%)] px-4 py-4 sm:px-6 sm:py-6">
                    <div className="max-w-[88%] sm:max-w-[76%] rounded-[26px] rounded-tl-md bg-white px-4 py-3 text-sm text-neutral-600 shadow-sm">
                      <p>Hi Priya 👋</p>
                      <p>Your appointment is confirmed for <strong>Tomorrow at 4:00 PM.</strong></p>
                    </div>
                    <div className="ml-auto max-w-[50%] rounded-[26px] rounded-tr-md bg-gradient-to-r from-emerald-500 to-green-500 px-4 py-3 text-sm text-white shadow-sm">Great, thank you.</div>
                    <div className="max-w-[92%] sm:max-w-[82%] rounded-[26px] rounded-tl-md bg-white px-4 py-3 text-sm leading-8 text-neutral-600 shadow-sm">
                      ...
                      <div className="mt-1 rounded-xl bg-neutral-100 p-2">
                        ...
                        <button className="mt-2 rounded-xl bg-indigo-600 px-4 py-2 text-sm text-white shadow-sm">Manage booking</button>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="absolute -left-0 lg:-left-5 -top-5 z-1 rounded-full bg-gradient-to-br from-emerald-500 to-green-500 shadow-xl p-4 animate-float">
              ...
              <div className="absolute right-5 -top-10 z-2 hidden lg:block rounded-xl bg-white px-4 py-4 shadow-sm animate-float ">
              ...
              <div className="absolute -bottom-10 right-5 z-2 rounded-xl bg-white px-4 py-4 shadow-sm animate-float">
              ...
              <div className="absolute -left-0 lg:-left-6 bottom-45 z-2 rounded-xl bg-white px-4 py-4 shadow-sm animate-float">
                <div className="text-sm uppercase">Message status</div>
                <div className="mt-2 flex items-center gap-2">
                  <div className="h-2 w-2 rounded-full bg-emerald-600" />
                  <div className="font-medium text-neutral-600">Delivered instantly</div>
                </div>
              </div>
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-12 lg:gap-10">
            ...
            <div className="relative lg:col-span-6">
              <div className="group relative w-full rounded-3xl bg-white/20 p-4 shadow-xl transition-all duration-500">
                <div className="w-full gap-4 rounded-2xl bg-white p-4">
                  <div className="relative">
                      ...
                      <div className="grid grid-cols-7 gap-2">
                        {[
                          ...
                          <button
                            ...
                            type="button"
                            className={`rounded-lg border px-1 py-2 text-center text-sm font-medium text-neutral-600 transition-all duration-200 sm:rounded-xl ${
                              item.active
                          ...
                          >
                            ...
                            <div className="font-bold leading-none sm:text-lg">{item.date}</div>
                            <div className={`text-xs ${item.active ? "text-white/90" : "text-neutral-500"}`}>{item.month}</div>
                          </button>
                        ))}
                      </div>
                    </div>
                      ...
                      <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 lg:grid-cols-4">
                        {[
                          ...
                          <button
                            key={time}
                            type="button"
                            className={`rounded-xl border px-2 py-2 text-sm font-medium text-neutral-600 transition-all duration-200 ${
                              time === "10:00 AM"
                                ? "border-indigo-500 bg-gradient-to-b from-indigo-500 to-indigo-600 text-white shadow-md shadow-indigo-300/60"
                    ...
                    <div className="flex items-center justify-end mt-3">
                      <button className="rounded-xl bg-indigo-600 px-4 py-2.5 text-sm font-medium text-white shadow-sm">Continue</button>
                    </div>
                  </div>
                </div>
              </div>
              <div className="animate-float rounded-xl bg-white p-3 shadow-lg transition-all duration-500 group-hover:shadow-xl w-50 absolute -top-10 right-0 group-hover:-translate-y-1">
