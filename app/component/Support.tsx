         ...
         <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
           ...
           <div className="lg:col-span-7 space-y-6">
             ...
             <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3">
               {["Instant response from our support team","Live specialist guidance available", "Priority support for urgent issues", "Multiple contact channels— Chat, email, phone"].map((item) => (
                 <li key={item} className="flex items-center gap-3 text-sm text-neutral-700">
                   <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-500 to-violet-500 text-md font-semibold text-white shadow-lg shadow-indigo-500/25">✓</div>
             ...
             <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
               <div className="group rounded-2xl p-5  bg-gradient-to-br from-transparent via-indigo-200/20 to-transparent backdrop-blur-md border border-white/30 shadow-sm hover:shadow-xl transition-all">
               ...
               <div className="p-5">
                 ...
                 <div className="mt-4 rounded-2xl bg-white/80 backdrop-blur-md p-4 shadow">
                    ...
                    <div className="mt-3 space-y-3">
                      ...
                      <div className="ml-auto max-w-[80%] rounded-2xl rounded-br-sm bg-gradient-to-r from-indigo-500 to-indigo-500 text-white p-3 text-xs">Yes — how do I send a 24h whatsapp message and 2h email?</div>
                      <div className="max-w-[80%] rounded-2xl rounded-bl-sm bg-neutral-100 p-3 text-xs text-neutral-800">I&apos;ll guide you. Open Notifications → Reminders, add two steps, then select whatsapp and email. Want me to do it for you?</div>
                    </div>
