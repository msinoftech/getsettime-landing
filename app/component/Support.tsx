         ...
         <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
           ...
           <div className="lg:col-span-7 space-y-4">
              <Heading
                ...
                title="Expertly 24/7 Dedicated"
                highlightText="Support When You Need"
                description="Our support team is always available to ensure the scheduling system runs smoothly so that no appointment is missed."
              />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 hidden sm:grid">
                <div className="group rounded-lg p-4 bg-gradient-to-br from-transparent via-indigo-200/20 to-transparent shadow-sm hover:shadow-xl transition-all">
           ...
           <div className="lg:col-span-5">
             <div className="relative overflow-hidden rounded-xl bg-white/20 shadow-xl">
               <div className="p-4">
                 <div className="flex flex-wrap items-start justify-between rounded-lg bg-white/80 p-3 shadow-sm">
                 ...
                 <div className="mt-4 rounded-lg bg-white sm:p-4 sm:shadow-sm">
                    <div className="text-sm font-semibold text-neutral-900">Support Chat</div>
                    <div className="mt-3 space-y-3">
                      <div className="max-w-[80%] rounded-lg bg-neutral-100 p-3 text-sm text-neutral-800">Hi! Need help setting up reminder workflows?</div>
                      <div className="ml-auto max-w-[80%] rounded-lg bg-gradient-to-r from-indigo-500 to-indigo-500 text-white p-3 text-sm">Yes — how do I send a 24h whatsapp message and 2h email?</div>
                      <div className="max-w-[80%] rounded-lg bg-neutral-100 p-3 text-sm text-neutral-800">I&apos;ll guide you. Open Notifications → Reminders, add two steps, then select whatsapp and email. Want me to do it for you?</div>
                    </div>
