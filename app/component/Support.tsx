           ...
           <div className="lg:col-span-7 space-y-6">
             <div className="space-y-3">
              ...
              <h2 className="text-3xl md:text-4xl lg:text-[40px] font-bold text-neutral-900">
               ...
               <p>Our support team is always available to ensure the scheduling system runs smoothly so that no appointment is missed.</p>
             </div>
             ...
             <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3">
               {["Instant response from our support team","Live specialist guidance available", "Priority support for urgent issues", "Multiple contact channels— Chat, email, phone"].map((item) => (
                 <li key={item} className="flex items-center gap-3 text-neutral-600">
                   <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-600 to-indigo-500 text-white shadow-lg shadow-indigo-500/25">✓</div>
                   <p>{item}</p>
                 </li>
               ))}
             </ul>
             ...
             <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
               <div className="group rounded-xl p-5 bg-gradient-to-br from-transparent via-indigo-200/20 to-transparent shadow-sm hover:shadow-xl transition-all">
                 <div className="flex items-center gap-3">
                   ...
                   <div>
                     ...
                     <div className="text-sm text-neutral-600">Average response under 2 minutes</div>
                   </div>
                 </div>
               </div>
               <div className="group rounded-xl p-5 bg-gradient-to-br from-transparent via-indigo-200/20 to-transparent shadow-sm hover:shadow-xl transition-all">
                 <div className="flex items-center gap-3">
                   ...
                   <div>
                     ...
                     <div className="text-sm text-neutral-600">Guides, tutorials, and API docs</div>
                   </div>
                 </div>
               </div>
             </div>
               ...
               <div className="p-5">
                 ...
                 <div className="flex items-center justify-between rounded-xl bg-white/80 p-3 shadow-sm">
                   <div className="flex items-center gap-2">
                     ...
                     <span className="font-medium text-neutral-800">All systems operational</span>
                   </div>
                   <span className="text-sm text-neutral-500">Updated just now</span>
                 </div>

                 {/* Chat window */}
                 <div className="mt-4 rounded-xl bg-white/80 p-4 shadow">
                    <div className="font-semibold text-neutral-700">Support Chat</div>
                    <div className="mt-3 space-y-3">
                      <div className="max-w-[80%] rounded-xl rounded-bl-sm bg-neutral-100 p-3 text-sm text-neutral-800">Hi! Need help setting up reminder workflows?</div>
                      <div className="ml-auto max-w-[80%] rounded-xl rounded-br-sm bg-gradient-to-r from-indigo-500 to-indigo-500 text-white p-3 text-sm">Yes — how do I send a 24h whatsapp message and 2h email?</div>
                      <div className="max-w-[80%] rounded-xl rounded-bl-sm bg-neutral-100 p-3 text-sm text-neutral-800">I&apos;ll guide you. Open Notifications → Reminders, add two steps, then select whatsapp and email. Want me to do it for you?</div>
                    </div>
                    <div className="mt-4 flex items-center gap-2">
                      <input aria-label="Type your message" placeholder="Type your message..." className="w-full rounded-xl bg-white/80 px-3 py-2 text-sm text-neutral-800 placeholder-neutral-400" />
                      <button className="rounded-xl cursor-pointer bg-indigo-600 text-white text-sm px-5 py-3">Send</button>
                    </div>
                 </div>
