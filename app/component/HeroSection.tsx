        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-8">
          ...
          <div className="text-center lg:text-left space-y-6">
            ...
            <div className="space-y-6">
              <h1 className="text-3xl md:text-4xl lg:text-[50px] font-extrabold text-neutral-900">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Link href={`${REGISTER_URL}`} target="_blank" className="bg-indigo-600 text-white text-sm px-5 py-3 rounded-xl flex items-center justify-center gap-3">
              ...
              <Link href={`${BASE_URL}/contact-us`} className="bg-gray-900 text-white text-sm px-5 py-3 rounded-xl flex items-center justify-center">Start Free Trial</Link>
            </div>
                ...
                <div className="relative z-10 grid grid-cols-12 gap-2 sm:gap-3">
                  ...
                  <div className="col-span-12 sm:col-span-6 bg-white/10 rounded-xl sm:rounded-2xl p-2.5 sm:p-3 md:p-4">
                    <div className="flex items-center justify-between mb-2 sm:mb-3">
                      <h4 className="font-semibold text-neutral-800">Today&apos;s Bookings</h4>
                  ...
                  <div className="col-span-12 sm:col-span-6 bg-white/10 rounded-xl sm:rounded-2xl p-2.5 sm:p-3 md:p-4">
                    <div className="flex items-center justify-between mb-2 sm:mb-0">
                      <h4 className="font-semibold text-neutral-800">Upcoming Meetings</h4>
                    </div>
                    <div className="mb-2">Tue 30 Apr</div>
                    <div className="space-y-2">
                      {[
                        ...
                        <div key={idx} className="flex items-center gap-2 p-2 rounded-lg sm:rounded-xl bg-white shadow-md hover:-translate-y-1 transition-all duration-300 cursor-pointer">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-sm">{meeting.name} • {meeting.role}</p>
                            <p className="text-sm">{meeting.time} • {meeting.date}</p>
                          </div>
                        </div>
                      ))}
                    </div>
                  ...
                  <div className="col-span-12 sm:col-span-6 space-y-1.5 sm:space-y-2 p-2.5 sm:p-3 md:p-4">
                    <button className="w-full bg-gradient-to-r from-indigo-600 to-blue-500 text-white text-sm py-3 px-5 rounded-xl transition-all duration-200 hover:scale-105 shadow-lg flex items-center justify-center gap-2">
                      <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                      </svg>
                      <span className="truncate">New Booking</span>
                    </button>
                    <button className="w-full bg-gradient-to-r from-indigo-600 to-blue-500 text-white text-sm py-3 px-5 rounded-xl transition-all duration-200 hover:scale-105 flex items-center justify-center gap-2">
                      <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
