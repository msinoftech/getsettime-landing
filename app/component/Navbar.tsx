      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-3">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-4">
            ...
            <Link href={`${BASE_URL}/contact-us`} className="rounded-xl bg-indigo-600 text-white text-sm px-5 py-2.5">Get Started Free</Link>
          </div>
          ...
          <div className="fixed h-full top-0 right-0 w-full max-w-sm lg:hidden z-50 bg-white/95 backdrop-blur-xl shadow-2xl border-l border-gray-200/50 animate-slide-in-right">
            ...
            <div className="flex flex-col h-[calc(100%-80px)] overflow-y-auto">
              ...
              <div className="px-6 py-6 space-y-3 mt-auto">
                <Link href={`${LOGIN_URL}`} target="_blank" className="flex items-center justify-center w-full px-5 py-2.5 rounded-xl text-sm text-indigo-600 bg-indigo-50" onClick={() => setOpen(false)}>Sign In</Link>
                <Link href={`${BASE_URL}/contact-us`} className="flex items-center justify-center w-full px-5 py-2.5 rounded-xl text-sm text-white bg-gradient-to-r from-indigo-600 to-blue-600" onClick={() => setOpen(false)}>Get Started Free</Link>
              </div>
            </div>
          </div>
        </>
